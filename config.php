...
// Navigation in separate config since it is more prone to variations
//
...
define('WS_FOOTER', 	'&copy; 2013 by Mats Ljungquist - version 0.7');       // Footer at the end of the page.
